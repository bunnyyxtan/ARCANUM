  ...
  return (
    <main className="min-h-[100dvh] overflow-hidden bg-[#faf6f1] text-[#292522]" style={{ fontFamily: "'Inter Tight', sans-serif" }}>
      ...
      <aside className="fixed bottom-0 left-0 top-0 z-20 hidden w-[86px] flex-col items-center justify-between border-r border-[#ded7d0] bg-[#faf6f1] py-7 lg:flex">
        <MagneticAnchor href="#" className="text-[17px] font-bold tracking-[-.08em]" >ARCANUM<span className="text-[#ff3c00]">.</span></MagneticAnchor>
      ...
      <div className="lg:pl-[86px]">
        <nav className="flex items-center justify-between border-b border-[#ded7d0] px-6 py-5 lg:hidden"><MagneticAnchor href="#" className="text-[18px] font-bold tracking-[-.06em]">ARCANUM<span className="text-[#ff3c00]">.</span></MagneticAnchor><MagneticAnchor href="/dashboard" className="warm-pill group rounded-full bg-[#ff3c00] px-5 py-2.5 text-[11px] font-semibold text-white">Launch Dashboard<Arrow /></MagneticAnchor></nav>
        ...
        <section id="ledger" className="relative min-h-[780px] border-b border-[#ded7d0] px-6 py-16 lg:px-10 lg:py-20">
          ...
          <div className="relative mx-auto max-w-[1400px]">
            ...
            <Reveal kind="headline" className="delay-1"><h1 className="mt-8 max-w-[880px] text-[clamp(4.4rem,10.5vw,10.5rem)] font-semibold leading-[.8] tracking-[-.1em]">Autonomous<br /><span className="text-[#8d837b]">spend,</span> <em className="not-italic text-[#292522]">accounted.</em></h1></Reveal>
        ...
        <section id="record" className="bg-[#292522] px-6 py-28 text-[#faf6f1] lg:px-10 lg:py-32"><div className="mx-auto grid max-w-[1400px] gap-16 lg:grid-cols-[240px_1fr]"><Reveal><p className="font-mono text-[10px] uppercase tracking-[.18em] text-[#ff3c00]">03 / Trust surface</p><SectionNumber value="3" className="mt-28 hidden font-mono text-[80px] leading-none tracking-[-.1em] text-[#49423d] lg:block" /></Reveal><Reveal className="delay-1"><div className="flex flex-col justify-between gap-10 md:flex-row md:items-end"><h2 className="max-w-[680px] text-[clamp(3rem,6vw,6rem)] font-semibold leading-[.84] tracking-[-.085em]">Nothing moves<br /><span className="text-[#8f857c]">in the dark.</span></h2><p className="max-w-[240px] text-[12px] leading-[1.5] text-[#a69d94]">A quiet, immutable record of what your agents tried, what policy decided, and who stepped in.</p></div><div className="mt-16"><LedgerRows dark /></div></Reveal></div></section>
