    ...
    <main className="min-h-[100dvh] bg-[#faf6f1] text-[#292522]" style={{ fontFamily: "'Inter Tight', sans-serif" }}>
      ...
      <Header active="VENDORS" /><header className="hidden flex min-h-[68px] flex-wrap items-center justify-between gap-4 border-b border-[#ded7d0] px-5 py-4 sm:h-[68px] sm:flex-nowrap sm:px-8 sm:py-0">
        <div className="flex min-w-0 items-center gap-7">
          <a href="/__mockup/preview/arcanum-app/Vendors" className="shrink-0 text-[18px] font-bold tracking-[-.05em]">ARCANUM<span className="text-[#ff3c00]">.</span></a>
  ...
  return (
    <AppShell>
      ...
      <section className="mt-8 grid grid-cols-3 divide-x divide-[#ded7d0] border border-[#ded7d0] bg-[#f5f0ea]">
        <div className="p-5 sm:p-7"><span className="font-mono text-[9px] tracking-[.15em] text-[#837a72]">APPROVED</span><strong className="mt-6 block text-4xl font-semibold tracking-[-.045em]">8</strong><span className="mt-2 block font-mono text-[9px] text-[#9b9289]">COUNTERPARTIES</span></div>
        <div className="p-5 sm:p-7"><span className="font-mono text-[9px] tracking-[.15em] text-[#837a72]">CATEGORIES</span><strong className="mt-6 block text-4xl font-semibold tracking-[-.045em]">4</strong><span className="mt-2 block font-mono text-[9px] text-[#9b9289]">ACTIVE GROUPS</span></div>
        <div className="p-5 sm:p-7"><span className="font-mono text-[9px] tracking-[.15em] text-[#837a72]">BLOCKED</span><strong className="mt-6 block text-4xl font-semibold tracking-[-.045em] text-[#ff3c00]">2</strong><span className="mt-2 block font-mono text-[9px] text-[#9b9289]">COUNTERPARTIES</span></div>
      </section>

      <section className="mt-14">
        <div className="flex flex-col justify-between gap-4 border-b border-[#292522] pb-4 lg:flex-row lg:items-end"><div><p className="font-mono text-[10px] uppercase tracking-[.18em] text-[#ff3c00]">REGISTRY / GOVERNED</p><h2 className="mt-3 text-2xl font-semibold tracking-[-.05em]">Vendor registry</h2></div><span className="font-mono text-[9px] tracking-[.12em] text-[#9b9289]">{notice}</span></div>
