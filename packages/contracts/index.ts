...
export const GuardedWalletAbi = [
  ...
  {
    type: "event",
    name: "AnomalyFreezeThresholdUpdated",
    inputs: [
      {
        name: "wallet",
        type: "address",
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: "uint8",
        indexed: true,
        internalType: "enum FreezeSource",
      },
      {
        name: "reason",
        type: "uint8",
    ...
    outputs: [
      {
        name: "terms",
        type: "tuple",
        internalType: "struct IEscalationManager.Terms",
        components: [
          {
            name: "escalationId",
            type: "bytes32",
...
export const WalletFactoryAbi = [
  {
    ...
    inputs: [
      ...
      {
        name: "initialDefaults",
        type: "tuple",
        internalType: "struct WalletFactory.Defaults",
        components: [
          {
            name: "policyEngine",
            type: "address",
