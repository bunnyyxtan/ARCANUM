...
async def run_poc():
    ...
    # Mocking web3 and contract behavior
    client.wallet.functions.escalationManager.return_value.call = AsyncMock(return_value="0x1234")
    
    mock_manager = MagicMock()
    mock_status_call = AsyncMock()
    mock_status_call.call = AsyncMock(return_value=1) # 1 = EXECUTED
    mock_manager.functions.statusOf.return_value = mock_status_call
