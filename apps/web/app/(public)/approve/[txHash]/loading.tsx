export default function Loading() {
  return (
    <main className="mx-auto max-w-[1080px] px-5 py-6 md:px-9 md:py-16">
      ...
      <div className="mt-6 grid gap-4 border border-[var(--wl-line-bold)] bg-[var(--wl-bg-raised)] p-5 md:mt-10 md:p-8 md:grid-cols-[1.15fr_.85fr]">
